...
Le diagramme présenté à la figure \ref{fig:acteurs} illustre les acteurs principaux de l'application et leurs interactions avec le système.  
...
\noindent
Ce diagramme de cas d'utilisation montre les différents types d'utilisateurs (Visiteur, Utilisateur enregistré, Administrateur) et leurs interactions avec le système. 
\newline 
